...
package com.snapdonate.app.vuforia;
...
public class SampleAppMenuGroup
{
        ...
        int width)
    {
        ...
        mLayout = (LinearLayout) inflater.inflate(
            R.layout.snap_donate_app_menu_group, null, false);
        ...
        dividerResource = R.layout.snap_donate_app_menu_group_divider;
        ...
        if (!hasTitle)
        {
            ...
            View dividerView = mLayout
                .findViewById(R.id.titleDividerView);
    ...
    public View addRadioItem(String text, int command, boolean isSelected)
    {
        ...
        RadioButton newRadioButton = (RadioButton) inflater.inflate(
            R.layout.snap_donate_app_menu_group_radio_button, null, false);
